...
console.log('listFromPlainArray', listFromPlainArray.toJS())
...
// console.log('myList2', Array.from(myList2))
...
const immutableCharacter = Immutable.List(characters)
const immutableCharacter1 = immutableCharacter.set(5, {
    name: 'Kathryn Janeway',
    role: 'Captain',
    universe: 'Star Trek',
    weapon: 'Wit',
...
//or
const immutableCharacter2 = immutableCharacter.push({
    name: 'Kathryn Janeway',
    role: 'Captain',
    universe: 'Star Trek',
    weapon: 'Wit',
...
const immutableCharacter3 = immutableCharacter.remove(1)
// console.log('immutableCharacter: ', immutableCharacter.toJS())
// console.log('immutableCharacter1: ', immutableCharacter1.toJS())
console.log('immutableCharacter2: ', immutableCharacter2.toJS())
console.log('immutableCharacter3: ', Array.from(immutableCharacter2))
